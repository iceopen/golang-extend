...
import (
	...
	"github.com/iceopen/golang-extend/demo/prometheus/collector"
...
var (
	...
	// 命令行参数
	listenAddr       = flag.String("web.listen-port", "9900", "An port to listen on for web interface and telemetry.")

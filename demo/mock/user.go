//go:generate mockgen -destination mock_user/mock_user.go github.com/iceopen/golang-extend/demo Index,Embed,Embedded
...
import (
	"github.com/iceopen/golang-extend/demo/mock/imp1"
	renamed2 "github.com/iceopen/golang-extend/demo/mock/imp2"
	. "github.com/iceopen/golang-extend/demo/mock/imp3"
	"github.com/iceopen/golang-extend/demo/mock/imp4" // calls itself "imp_four"
)
